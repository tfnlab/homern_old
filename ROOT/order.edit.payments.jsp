                      ...
                      if (request.getParameter("paymentAmount") != null && !request.getParameter("paymentAmount").isEmpty()) {
                        ...
                        if (request.getParameter("pId") != null && !request.getParameter("pId").isEmpty()) {
                          if(request.getParameter("pId").equals("ap")){
                                ...
                                Payment payment = new Payment(0, ocDao.getCustomersById(ocId).getCustomer().getId(), new Date(), new Date(), new Date(), paymentAmount, "Quick Pay", true, false, new Date(), new Date(), username, currentTime, paymentAmount);
