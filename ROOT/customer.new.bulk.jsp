  ...
  <main id="main">
    ...
    <section id="blog" class="blog">
      <div class="container px-4 px-lg-5">
        ...
        <%
          ...
          if (isMultipart) {
              ...
              //                      entity.setId(Integer.parseInt(request.getParameter("id")));
                                ...
                                entity.setCompany_name(customers[7].substring(1, customers[7].length() - 1));
                                entity.setDisplay_name(customers[2].substring(1, customers[2].length() - 1));
        ...
        <HR>
          <form method="post" action="customer.new.bulk.jsp" enctype="multipart/form-data">
